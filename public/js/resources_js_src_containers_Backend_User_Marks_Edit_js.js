(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Marks_Edit_js"],{
...
/***/ "./resources/js/src/containers/Backend/User/Marks/Add.js":
/*!***************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Marks/Add.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  _createClass(Add, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          _this$props$content$c2 = _this$props$content$c.backend.pages.marks,
      ...
      var year = years.find(function (year) {
        return +year.id === +year_id;
      });
      var sessions = year ? year.sessions : [];
      var sessionsOptions = sessions.sort(function (a, b) {
        return a.name > b.name;
      }).map(function (item) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
          value: item.id,
      ...
      var trimesters = session ? session.trimesters : [];
      var trimestersOptions = trimesters.sort(function (a, b) {
        return a.name > b.name;
      }).map(function (item) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
          value: item.id,
      ...
      var students = session ? session.students : [];
      var studentsOptions = students.sort(function (a, b) {
        return a.name > b.name;
      }).map(function (item) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
          value: item.id,
      ...
      var trimester = trimesters.find(function (trimester) {
        return +trimester.id === +trimester_id;
      });
      var sequences = trimester ? trimester.sequences : [];
      var sequencesOptions = sequences.sort(function (a, b) {
        return a.name > b.name;
      }).map(function (item) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
          value: item.id,
      ...
      var sequence = sequences.find(function (sequence) {
        return +sequence.id === +sequence_id;
      });
      var exams = sequence ? sequence.exams : [];
      var examsOptions = exams.sort(function (a, b) {
        return a.name > b.name;
      }).map(function (item) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
          value: item.id,
        ...
        content = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_17__.default, {
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Backend_UI_Form_Form__WEBPACK_IMPORTED_MODULE_10__.default, {
              ...
              icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_18__.faMarker,
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(reactstrap__WEBPACK_IMPORTED_MODULE_16__.default, {
                ...
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Feedback_Feedback__WEBPACK_IMPORTED_MODULE_13__.default, {
                  ...
                  name: "_method",
                  defaultValue: "PATCH"
                }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(reactstrap__WEBPACK_IMPORTED_MODULE_17__.default, {
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_11__.default, {
                    ...
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_18__.faCalendar,
                    validation: {
                      required: true
                    },
                    required: true,
                    ...
                    type: "select",
                    name: "session_id",
                    placeholder: form.session,
                    onChange: this.inputChangeHandler,
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_18__.faSchool,
                    validation: {
                      required: true
                    },
                    required: true,
                    value: session_id,
                    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
                      children: form.select_session
                    }), sessionsOptions]
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_11__.default, {
                    className: "col-lg-6",
                    type: "select",
                    name: "student_id",
                    placeholder: form.student,
                    onChange: this.inputChangeHandler,
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_18__.faUserGraduate,
                    validation: {
                      required: true
                    },
                    required: true,
                    value: student_id,
                    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
                      children: form.select_student
                    }), studentsOptions]
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_11__.default, {
                    className: "col-lg-6",
                    type: "select",
                    name: "trimester_id",
                    placeholder: form.trimester,
                    onChange: this.inputChangeHandler,
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_18__.faClock,
                    validation: {
                      required: true
                    },
                    required: true,
                    value: trimester_id,
                    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
                      children: form.select_trimester
                    }), trimestersOptions]
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_11__.default, {
                    className: "col-lg-6",
                    type: "select",
                    name: "sequence_id",
                    placeholder: form.sequence,
                    onChange: this.inputChangeHandler,
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_18__.faFilm,
                    validation: {
                      required: true
                    },
                    required: true,
                    value: sequence_id,
                    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
                      children: form.select_sequence
                    }), sequencesOptions]
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_11__.default, {
                    className: "col-lg-6",
                    type: "select",
                    name: "exam_id",
                    placeholder: form.exam,
                    onChange: this.inputChangeHandler,
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_18__.faCopy,
                    validation: {
                      required: true
                    },
                    required: true,
                    ...
                    type: "textarea",
                    className: "col-md-6",
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_18__.faParagraph,
                    onChange: this.inputChangeHandler,
                    value: comment,
                    name: "comment",
                    required: true,
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.marks.mark && prevState.student_id === '') {
        var mark = nextProps.backend.marks.mark;
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_15__.updateObject)(prevState, _objectSpread({}, mark));
      }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.getMark(id));
    },
    info: function info() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.getMarksInfo());
    },
    post: function post(data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.postMarks(data));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.patchMarks(id, data));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.resetMarks());
    }
  };
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_router_dom__WEBPACK_IMPORTED_MODULE_20__.withRouter)((0,react_redux__WEBPACK_IMPORTED_MODULE_3__.connect)(mapStateToProps, mapDispatchToProps)(Add)));

/***/ }),

/***/ "./resources/js/src/containers/Backend/User/Marks/Edit.js":
/*!****************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Marks/Edit.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _Add__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Add */ "./resources/js/src/containers/Backend/User/Marks/Add.js");
