(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Sessions_Edit_js"],{
...
/***/ "./resources/js/src/containers/Backend/User/Sessions/Add.js":
/*!******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Sessions/Add.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_Backend_UI_Form_Form__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../components/Backend/UI/Form/Form */ "./resources/js/src/components/Backend/UI/Form/Form.js");
/* harmony import */ var _components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../components/Backend/UI/Input/Input */ "./resources/js/src/components/Backend/UI/Input/Input.js");
/* harmony import */ var _components_UI_Button_BetweenButton_BetweenButton__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../components/UI/Button/BetweenButton/BetweenButton */ "./resources/js/src/components/UI/Button/BetweenButton/BetweenButton.js");
  ...
  function Add() {
    ...
    _defineProperty(_assertThisInitialized(_this), "inputChangeHandler", function (e) {
      ...
      if (name.includes('subjects')) {
        var subjects = _toConsumableArray(_this.state.subjects);

        if (name.includes('id')) {
          var _id$split = id.split('-'),
              _id$split2 = _slicedToArray(_id$split, 2),
              subject_id = _id$split2[1];

          var subject = subjects.find(function (c) {
            return +c.id === +subject_id;
          });
          if (checked && !subject) subjects.push({
            id: subject_id,
            coef: ''
          });else subjects = subjects.filter(function (c) {
            return +c.id !== +subject_id;
          });
        } else if (name.includes('coef')) {
          var _id$split3 = id.split('-'),
              _id$split4 = _slicedToArray(_id$split3, 2),
              _subject_id = _id$split4[1];

          var subjectIndex = subjects.findIndex(function (c) {
            return +c.id === +_subject_id;
          });
          console.log({
            value: value,
            subjects: subjects,
      ...
      if (name.includes('students')) {
        var students = _toConsumableArray(_this.state.students);

        if (name.includes('id')) {
          var _id$split5 = id.split('-'),
              _id$split6 = _slicedToArray(_id$split5, 2),
              student_id = _id$split6[1];

          var student = students.find(function (c) {
            return +c.id === +student_id;
          });
          if (checked && !student) students.push({
            id: student_id // coef: '' 

          });else students = students.filter(function (c) {
            return +c.id !== +student_id;
          });
        } // else if (name.includes('coef')) {
  ...
  _createClass(Add, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$content$c2 = _this$props$content$c.backend.pages.sessions,
          ...
          _this$props$backend$s = _this$props.backend.sessions,
          loading = _this$props$backend$s.loading,
          error = _this$props$backend$s.error,
          message = _this$props$backend$s.message,
          years = _this$props$backend$s.years,
          cycles = _this$props$backend$s.cycles,
          subjects = _this$props$backend$s.subjects,
          students = _this$props$backend$s.students,
          features = _this$props.auth.data.role.features;
      var _this$state = this.state,
          year_id = _this$state.year_id,
          cycle_id = _this$state.cycle_id,
          level_id = _this$state.level_id,
          classroom_id = _this$state.classroom_id,
          subs = _this$state.subjects,
          studs = _this$state.students;
      var content = null;
      var errors = null;
      ...
      var redirect = !(feature && JSON.parse(feature.permissions).includes(this.props.edit ? 'u' : 'c')) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Redirect, {
        to: "/user/dashboard"
      });

      if (!subjects) subjects = [];
      var subjectsItems = subjects.sort(function (a, b) {
        return a.name > b.name;
      }).map(function (subject) {
        var element = subs.find(function (i) {
          return +i.id === +subject.id;
        });
        var checked = element !== undefined;
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(reactstrap__WEBPACK_IMPORTED_MODULE_16__.default, {
          lg: 4,
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_17__.default, {
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_18__.default, {
              type: "switch",
              id: "subject-".concat(subject.id),
              className: "col-12 pb-2",
              checked: checked,
              name: "subjects[".concat(subject.id, "][id]"),
          ...
          }), checked && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_17__.default, {
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_11__.default, {
              type: "number",
              id: "subject-".concat(subject.id, "-coef"),
              name: "subjects[".concat(subject.id, "][coef]"),
              icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_19__.faPercentage,
              onChange: _this2.inputChangeHandler,
              value: element.coef,
              placeholder: form.coef
            })
          })]
        }, JSON.stringify(subject));
      });
      if (!students) students = [];
      var studentsItems = students.sort(function (a, b) {
        return a.name > b.name;
      }).map(function (student) {
        var element = studs.find(function (i) {
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_18__.default, {
            ...
            className: "col-12 pb-2",
            checked: checked,
            name: "students[".concat(student.id, "][id]"),
            onChange: _this2.inputChangeHandler,
            label: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", {
              className: "text-500",
      ...
      if (!years) years = [];
      var yearsOptions = years.sort(function (a, b) {
        return a.name > b.name;
      }).map(function (item) {
      ...
      if (!cycles) cycles = [];
      var cyclesOptions = cycles.sort(function (a, b) {
        return a.name > b.name;
      }).map(function (item) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
          value: item.id,
      ...
      var cycle = cycles.find(function (cycle) {
        return +cycle.id === +cycle_id;
      });
      var levels = cycle ? cycle.levels : [];
      var levelsOptions = levels.sort(function (a, b) {
        return a.name > b.name;
      }).map(function (item) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
          value: item.id,
      ...
      var level = levels.find(function (level) {
        return +level.id === +level_id;
      });
      var classrooms = level ? level.classrooms : [];
      var classroomsOptions = classrooms.sort(function (a, b) {
        return a.name > b.name;
      }).map(function (item) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
          value: item.id,
      ...
      if (loading) content = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_16__.default, {
        xs: 12,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_UI_CustomSpinner_CustomSpinner__WEBPACK_IMPORTED_MODULE_9__.default, {})
      });else {
        ...
        content = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_20__.default, {
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Backend_UI_Form_Form__WEBPACK_IMPORTED_MODULE_10__.default, {
              onSubmit: this.submitHandler,
              icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_19__.faSchool,
              title: this.props.edit ? edit : add,
              list: index,
              link: "/user/sessions",
              innerClassName: "row",
              className: "shadow-sm",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(reactstrap__WEBPACK_IMPORTED_MODULE_16__.default, {
                lg: 8,
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Feedback_Feedback__WEBPACK_IMPORTED_MODULE_13__.default, {
                  message: message
                }), this.props.edit && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("input", {
                  type: "hidden",
                  name: "_method",
                  defaultValue: "PATCH"
                }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(reactstrap__WEBPACK_IMPORTED_MODULE_20__.default, {
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_11__.default, {
                    className: "col-lg-6",
                    type: "select",
                    name: "year_id",
                    placeholder: form.year,
                    onChange: this.inputChangeHandler,
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_19__.faCalendar,
                    validation: {
                      required: true
                    },
                    required: true,
                    ...
                    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
                      children: form.select_year
                    }), yearsOptions]
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_11__.default, {
                    className: "col-lg-6",
                    type: "select",
                    name: "cycle_id",
                    placeholder: form.cycle,
                    onChange: this.inputChangeHandler,
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_19__.faCircleNotch,
                    validation: {
                      required: true
                    },
                    required: true,
                    ...
                    onChange: this.inputChangeHandler,
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_19__.faLayerGroup,
                    validation: {
                      required: true
                    },
                    required: true,
                    ...
                    type: "select",
                    name: "classroom_id",
                    placeholder: form.classroom,
                    onChange: this.inputChangeHandler,
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_19__.faChalkboardTeacher,
                    validation: {
                      required: true
                    },
                    required: true,
                    value: classroom_id,
                    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
                      children: form.select_classroom
                    }), classroomsOptions]
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_16__.default, {
                    xs: 12,
                    className: "pb-2 text-large text-700",
                    children: form.subjects
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_17__.default, {
                    className: "col-12",
                    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_20__.default, {
                      children: subjectsItems
                    })
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_16__.default, {
                    xs: 12,
                    className: "pb-2 text-large text-700",
                    children: form.students
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_17__.default, {
                    className: "col-12",
                    children: studentsItems
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
                    className: "col-12",
                    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_UI_Button_BetweenButton_BetweenButton__WEBPACK_IMPORTED_MODULE_12__.default, {
                      color: "green",
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_Backend_UI_TitleWrapper__WEBPACK_IMPORTED_MODULE_5__.default, {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Backend_UI_Breadcrumb_Breadcrumb__WEBPACK_IMPORTED_MODULE_4__.default, {
            ...
            icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_19__.faSchool
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_UI_Titles_SpecialTitle_SpecialTitle__WEBPACK_IMPORTED_MODULE_6__.default, {
            user: true,
            icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_19__.faSchool,
            children: title
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_UI_Titles_Subtitle_Subtitle__WEBPACK_IMPORTED_MODULE_7__.default, {
            user: true,
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.sessions.session && prevState.year_id === '') {
        var session = nextProps.backend.sessions.session;
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_15__.updateObject)(prevState, _objectSpread({}, session));
      }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.getSession(id));
    },
    info: function info() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.getSessionsInfo());
    },
    post: function post(data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.postSessions(data));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.patchSessions(id, data));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.resetSessions());
    }
  };
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_router_dom__WEBPACK_IMPORTED_MODULE_22__.withRouter)((0,react_redux__WEBPACK_IMPORTED_MODULE_3__.connect)(mapStateToProps, mapDispatchToProps)(Add)));

/***/ }),

/***/ "./resources/js/src/containers/Backend/User/Sessions/Edit.js":
/*!*******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Sessions/Edit.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _Add__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Add */ "./resources/js/src/containers/Backend/User/Sessions/Add.js");



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_Add__WEBPACK_IMPORTED_MODULE_2__.default, {
    edit: true
  });
});
